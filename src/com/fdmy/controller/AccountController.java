...
public class AccountController {
	...
	public String add(@Valid Account acc, BindingResult br) throws Exception {
		...
		String param = "item.code=" + acc.getItem().getCode() + "&department=" + java.net.URLEncoder.encode(acc.getDepartment(), "UTF-8") + "&createTime="+sdf.format(acc.getCreateTime() );
		return "redirect:/account/query?" + param;
	}
