...
public class DocumentController {
	...
	public String preview(@PathVariable String id, String filename, HttpServletRequest request, Model model) throws Exception {
		 ...
		 */
//		int result = convert.convertMStoHTML(sourceFileName, targetFileName);				//标清 
		convert.insertTextWaterMark("山西三元福达煤业有限公司","宋体",30,Color.gray, true, true, true);
		int result = convert.convertMStoHtmlOfSvg(sourceFileName, targetFileName);		//高清
		switch (result) {
		case 0:
